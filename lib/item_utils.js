module.exports = function (config) {
  ...
  api.fetch_all_children = function (item, req_id, callback) {
    var include_xml = false
    this.get_item_and_children(item, 0, req_id, [], callback, include_xml)
  }

  api.fetch_all_children = function (item, req_id, callback, include_xml) {
    this.get_item_and_children(item, 0, req_id, [], callback, include_xml)
  }

  api.get_item_and_children = function (item, count, req_id, searched_gtins, callback, include_xml) {
