(function () {
  ...
  module.exports = Database = function (config) {
    ...
    //this.mdb.trade_items.ensureIndex({gtin: 1, provider: 1, tm: 1, recipient: 1, tm_sub: 1, modified_ts: -1})
    this.mdb.trade_items.ensureIndex({recipient: 1, gtin: 1, provider: 1, tm: 1, tm_sub: 1, modified_ts: -1})
