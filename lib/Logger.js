...
Logger.prototype.db = function (msg, username, duration) {
  this.db_logs.saveLogEntry(msg, username, duration, function (err, result, entry) {
    if (err) return console.log('!!!Error saving object: ' + err)
    console.log('Persisted DB message ' + JSON.stringify(result))
  })
}
