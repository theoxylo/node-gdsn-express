module.exports = function (config) {
  ...
  var party_db = require('./trading_party.js')
...
/* actually, yes we are going to persist parties, items, publication, and subscriptions in the msg_archive for now, maybe later they will get their own collections for easier searching 
      // don't save linked objects to this collection, let client persist them elsewhere
