  ...
  api.saveMessage = function (xml, cb) {
    ...
    config.gdsn.msg_string_to_msg_info(xml, function (err, info) {
      ...
      if (info.trade_items) {
        ...
        delete info.trade_items // don't save trade items as part of message

        trade_items && trade_items.forEach(function (item) {
